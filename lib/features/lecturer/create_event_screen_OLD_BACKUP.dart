...
class _CreateEventScreenState extends ConsumerState<CreateEventScreen> {
  ...
  Future<void> _saveEvent({bool isDraft = false}) async {
    ...
    if (widget.eventId != null && _existingEvent != null) {
      ...
      // Lecturer creates event with Pending status (0) - needs Admin approval
      // Admin will need to approve before event becomes Active (1) and visible to students
      final result = await eventRepository.createEvent(
        ...
        visibility: _isPublic,
        status: 0, // Always Pending (0) for Lecturer - needs Admin approval
        capacity: capacityValue,
        imageUrl: imageUrl,
